...
//       delay: 100,
//     });
//   }, [title, description, latitude, longitude, price, type]);
...
//       {/* Horizontal Layout for Map and Information Card */}
//       <div className="flex flex-col md:flex-row md:space-x-8 w-full max-w-7xl" data-aos="fade-up">
//         {/* Map Section (Left Column) */}
//         <div className="w-full md:w-1/2 h-96 rounded-lg shadow-lg overflow-hidden" data-aos="fade-right">
//           {latitude && longitude ? (
//             <MapContainer
//               center={[latitude, longitude]}
//               zoom={12}
...
//         <div
//           className="w-full md:w-1/2 bg-white dark:bg-slate-800 shadow-lg rounded-lg p-8 space-y-4 transform transition-transform duration-500 hover:scale-105"
//           data-aos="fade-left"
//           data-aos-delay="200"
//         >
//           <h2 className="text-3xl font-semibold mb-4 text-center dark:text-white">{title || city}</h2>
...
//       {/* Offers Section */}
//       <div
//         className="w-full max-w-lg bg-blue-100 p-5 rounded-lg shadow-md transform transition-transform duration-500 hover:scale-105 mt-8"
//         data-aos="fade-up"
//         data-aos-delay="300"
//       >
//         <h2 className="text-2xl font-semibold mb-4 text-blue-900">Special Offers</h2>
